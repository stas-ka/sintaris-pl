...
| 15:04 UTC | 15:04 UTC | 15:04 UTC | 60m | Sync docs with v2026.3.43 (Screen DSL + FTS5/RAG + admin i18n merge) | Update deployment.md, telegram-bot.md, web-ui.md, bot-code-map.md, README.md, AGENTS.md, TODO.md §21+§4, merge checklist | 3 | 1 | claude-sonnet-4.6 | doc/arch/deployment.md, doc/arch/telegram-bot.md, doc/arch/web-ui.md, doc/bot-code-map.md, README.md, AGENTS.md, TODO.md, doc/todo/merge-ui-poc-to-openclaw.md | done |
...
| 18:30 UTC | 18:30 UTC | 18:45 UTC | 15m | Update user guide and arch docs (Variants, RAG, System Chat move, OpenClaw hosts) | howto_bot.md: Variants section, System Chat→Admin, RAG section, /help_guide; overview.md: target hosts, v2026.3.43; deployment.md: OpenClaw hosts + skill ref; features.md: §6 System Chat note, §11 FTS5/RAG | 2 | 1 | claude-sonnet-4.6 | doc/howto_bot.md, doc/arch/overview.md, doc/arch/deployment.md, doc/arch/features.md | done |
...
| 23:35 UTC | | 23:10 UTC | | 23:35 UTC | 25m | Fix root cause of language mixing: openclaw-gateway 409 conflict | Disabled openclaw-gateway Telegram channel (enabled:false in ~/.openclaw/openclaw.json); T44 regression test; 79 PASS/0 FAIL | 2 | 1 | claude-sonnet-4.6 | src/tests/test_voice_regression.py, doc/test-suite.md, doc/arch/deployment.md | done |
...
| 07:39 UTC | | 06:00 UTC | | 07:39 UTC | 99m | VPS monitoring for all 4 taris URLs + full multi-target setup completion | Add check_taris_instances() to SintarisMonitor; SintAItion tunnel (autossh -R 8086:8088); VPS nginx /supertaris/ /supertaris2/; stas admin on PI1/PI2/TS1; migrate PI1→TS1 PI2→TS2; ROOT_PATH config; stop TS1 telegram (409); update deployment.md | 4 | 3 | claude-sonnet-4.6 | /opt/sintaris-monitor/monitor.py (VPS), /etc/nginx/sites-enabled/agents.sintaris.net.conf (VPS), doc/arch/deployment.md, ~/.taris/bot.env (TS1+TS2) | done |
...
| 00:31 UTC | 00:15 UTC | 00:31 UTC | 16m | §22 Notes+§9.1 DB+§10 RAG deploy+tests+docs | Deploy v2026.3.30 to TS2 (all §22/§9.1/§10 code); 94 PASS 0 FAIL 1 WARN; T51-T54 added (note delete confirm, rename, zip, RAG injection); TODO §22/§9.1/§10 marked done; doc/arch/features.md §12 Notes section added; doc/test-suite.md T51-T54 + range T17-T54; committed 8462de1 | 3 | 1 | claude-sonnet-4.6 | src/tests/test_voice_regression.py, TODO.md, doc/test-suite.md, doc/arch/features.md | done |
...
| 12:42 UTC | | 12:38 UTC | | 12:42 UTC | 4m | docs: arch update for v2026.3.30+3 | llm-providers.md §20 multi-turn+tiered memory; features.md §11.6-7 RAG+doc admin; bot-code-map.md callbacks+functions | 1 | 1 | claude-sonnet-4.6 | doc/arch/llm-providers.md, doc/arch/features.md, doc/bot-code-map.md | done |
| 11:05 UTC | 10:55 UTC | 11:05 UTC | 10m | docs: arch navigation maps + Copilot instructions | conversation.md, data-layer.md (new); security.md expanded; architecture.md index updated; copilot-instructions.md arch topic table + 8 style rules; taris-update-doc SKILL.md Step2 rewrite; committed 2907f14 | 2 | 1 | claude-sonnet-4.6 | doc/arch/conversation.md, doc/arch/data-layer.md, doc/arch/security.md, doc/architecture.md, .github/copilot-instructions.md, .github/skills/taris-update-doc/SKILL.md | done |
